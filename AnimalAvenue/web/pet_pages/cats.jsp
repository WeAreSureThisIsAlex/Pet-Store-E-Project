    ...
    <div class="container"> 
        <div class="row" id="header-nav">
         ...
         <ul class="nav nav-tabs nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="cats.jsp">Cats</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row" id="cat-accessories">
            <div class="col-sm-12">
