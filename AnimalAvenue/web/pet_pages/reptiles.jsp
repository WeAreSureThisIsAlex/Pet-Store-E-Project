    ...
    <div class="container"> 
        <div class="row" id="header-nav">
          ...
          <ul class="nav nav-tabs nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="reptiles.jsp">Reptiles</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row" id="reptile-tanks">
            <div class="col-sm-12">
                <h1> Reptile Tanks </h1>
            </div>
        </div>
        <div class="row" id="tanks-row-one">
             <div class="column">
                <div class="content">
                    <img src="#" alt="">
                    <h3>Name</h3>
        ...
        <div class="row" id="tanks-row-two">
             <div class="column">
                <div class="content">
                    <img src="#" alt="">
                    <h3>Name</h3>
        ...
        <div class="row" id="reptile-accessories">
            <div class="col-sm-12">
                <h1> Reptile Accessories </h1>
            </div>
        </div>
