    ...
    <div class="container"> 
        <div class="row" id="header-nav">
          ...
          <ul class="nav nav-tabs nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="small_animals.jsp">Small Animals</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row" id="guinea-food">
            <div class="col-sm-12">
                <h1> Guinea Pig Food </h1>
            </div>
        </div>
        <div class="row" id="food-row-one">
            <div class="column">
        ...
        <div class="row" id="small-accessories">
            <div class="col-sm-12">
