...
<style>
    ...
    <div class="container"> 
        ...
        <ul class="nav nav-tabs nav-justified">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="aquatics.jsp">Aquatics</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row" id="fish-accessories">
            <div class="col-sm-12">
                <h1> Fish Accessories </h1>
            </div>
        </div>
